function [ YesClose, ang_vec, jmp  ] = Tail_Chase18D2(pp2, ang_vec, jmp, reso, tailT, NN )
% 2007 machine rev 7.28.18
...
for ii = 1:4
    for jj = 1:4
       cond40 = T40(1) == jj  || T0 == jj || T40(1) == ii  || T0 == ii ;
       if cond40
          cond40;
       end
        if ii == jj  || cond40 
...
if isempty(DotL) == 0
    ...
    for LL = 1:LL_sze
        ...
        rowL(LL) = find2rc( DotL(LL), 1)  ;   %rem(DotL(LL), (NN+1) ) ; % col are the tails        
